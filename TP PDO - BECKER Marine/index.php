...
<body>
    ...
    ?>
        ...
        <p> <?= $element['nom'] ?> jouable sur la console <?= $element['console'] ?> </p>

        <a href="showOne.php?id=<?= $element['id'] ?>">- Voir ce jeu en détail</a> <br>
        <a href="form_update?id=<?= $element['id'] ?>">- Modifier ce jeu</a> <br>
        <a href="delete.php?id=<?= $element['id'] ?>">- Supprimer ce jeu</a> <br>
        <br>
